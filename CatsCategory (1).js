...
const CatsCategory = () => {
  ...
  const [bookmarkColor, setBookmarkColor] = useState("purple"); // State to track bookmark color
  ...
  const toggleBookmarkColor = () => {
    setBookmarkColor(bookmarkColor === "purple" ? "pink" : "purple");
  };
      ...
      <View style={styles.profileItem}>
        <View style={styles.profileContainer}>
          ...
          <View style={styles.profileInfo}>
            ...
            <FontAwesome name="bookmark" size={22} color={bookmarkColor} style={styles.icon} onPress={toggleBookmarkColor} />
            </View>
          </View>
          </View>
          </View>
